...
static PyObject *addBaseUnit(PyObject *, PyObject *);
static PyObject *addDimensionlessUnit(PyObject *, PyObject *);
static PyObject *addOffsettedUnit(PyObject *, PyObject *);
static PyObject *addScaledUnit(PyObject *, PyObject *);
static PyObject *addMultipliedUnits(PyObject *, PyObject *);
static PyObject *addDividedUnits(PyObject *, PyObject *);
static PyObject *addInvertedUnit(PyObject *, PyObject *);
static PyObject *addInvertedUnit(PyObject *, PyObject *);
static PyObject *addInvertedUnit(PyObject *, PyObject *);
static PyObject *convert(PyObject *, PyObject *);
static PyObject *term(PyObject *, PyObject *);
...
void check_ut_read(char *xmlFile)
{
    ...
    if (ut_read == NULL) {
        ut_get_status() == UT_PARSE ? UT_ESYNTAX : UT_EIO;
    }
    return;
}

static PyObject *init(self, args)
PyObject *self;
PyObject *args;
{
    char *file = NULL;
...
static PyObject *addBaseUnit(self, args)
PyObject *self;
PyObject *args;
{
    extern ut_system *ut_read;
...
static PyObject *addDimensionlessUnit(self, args)
PyObject *self;
PyObject *args;
{
    extern ut_system *ut_read;
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING, "Udunits: Error mapping dimless uniti to %s",
                 unit);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
...
static PyObject *addOffsettedUnit(self, args)
PyObject *self;
PyObject *args;
{
    extern ut_system *ut_read;
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING, "Udunits: Error offsetting %s unit by %g",
                 oldunit, offset);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING,
                 "Udunits: Error mapping name %s unit to offsetted unit %s (by %g)",
                 newunit, oldunit, offset);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
...
static PyObject *addScaledUnit(self, args)
PyObject *self;
PyObject *args;
{
    extern ut_system *ut_read;
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING, "Udunits: Error scaling %s unit by %g",
                 oldunit, scale);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING,
                 "Udunits: Error mapping name %s unit to scaled unit %s (by %g)",
                 newunit, oldunit, scale);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
...
static PyObject *addMultipliedUnits(self, args)
PyObject *self;
PyObject *args;
{
    extern ut_system *ut_read;
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING, "Udunits: Error multiplying units %s and %s",
                 unit1, unit2);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING,
                 "Udunits: Error mapping name %s unit to multiplied units %s and %s",
                 newunit, unit1, unit2);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
...
static PyObject *addDividedUnits(self, args)
PyObject *self;
PyObject *args;
{
    extern ut_system *ut_read;
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING, "Udunits: Error dividing units %s and %s",
                 unit1, unit2);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING,
                 "Udunits: Error mapping name %s unit to divided units %s and %s",
                 newunit, unit1, unit2);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
...
static PyObject *addInvertedUnit(self, args)
PyObject *self;
PyObject *args;
{
    extern ut_system *ut_read;
    ...
    if (myutstatus != UT_SUCCESS) {
        snprintf(msg, MAX_STRING,
                 "Udunits: Error mapping name %s unit to inverted unit %s",
                 newunit, oldunit);
        PyErr_SetString(PyExc_TypeError, msg);
        return NULL;
    }
...
static PyObject *convert(self, args)
PyObject *self;
PyObject *args;
{
    char *unit1, *unit2;
    ...
    if (ut_get_status() != UT_SUCCESS) {
        sprintf(err, "UDUNITS Error: cannot convert from %s to %s", unit1,
                unit2);
...
static PyObject *term(self, args)
PyObject *self;
PyObject *args;
{
    extern ut_system *ut_read;
